...
public class GetPrefs extends AsyncTask<Void, Void, String[]> {
    ...
    protected String[] doInBackground(Void... foo) {
        ...
        MongoClientURI uri = new MongoClientURI("mongodb://twooldguys:WowSoOld@ds041218.mongolab.com:41218/homestay");
    ...
    protected void onPostExecute(String[] result) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(act, android.R.layout.simple_list_item_1);
